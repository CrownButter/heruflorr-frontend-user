...
const DefaultComponent = () => {
  ...
  const [showWhatsApp, setShowWhatsApp] = useState(false); // Start with false
  ...
  const generateWhatsAppLink = () => {
    ...
    return `https://wa.me/+6282122075918?text=${formattedMessage}`;
  };
    ...
    <>
      {isLoading ? (
        ...
        <div className="relative flex w-full h-[70vh] mt-[20vh]">
          ...
          {showWhatsApp && (
            <div className="fixed z-50 bottom-6 right-4 flex items-end flex-col p-2 bg-white rounded shadow-lg">
              <button
              ...
              <input
                ...
                placeholder="Nama"
                className="border p-2 rounded mt-2 border-[#0e540e]"
              />
              <input
                type="text"
                value={address}
          ...
          <div className="fixed z-50 bottom-6 right-4">
            <button
              ...
              className="bg-[#25D366] rounded-full p-3 shadow-lg"
            >
